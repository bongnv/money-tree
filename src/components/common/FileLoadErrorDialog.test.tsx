...
describe('FileLoadErrorDialog', () => {
  ...
  it('should render when open with error message', () => {
    render(<FileLoadErrorDialog open={true} error="Failed to parse file" onClose={mockOnClose} />);
  ...
  it('should render default message when error is null', () => {
    render(<FileLoadErrorDialog open={true} error={null} onClose={mockOnClose} />);
  ...
  it('should not render when closed', () => {
    render(<FileLoadErrorDialog open={false} error="Some error" onClose={mockOnClose} />);
