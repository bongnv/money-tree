import { StorageFactory, StorageProviderType, LocalStorageProvider } from './index';
...
describe('StorageFactory', () => {
  ...
  describe('getCurrentProvider', () => {
    ...
    it('should throw error for OneDrive provider (not yet implemented)', () => {
      StorageFactory.setProviderType(StorageProviderType.ONEDRIVE);
      expect(() => StorageFactory.getCurrentProvider()).toThrow(
        'OneDrive storage provider not yet implemented'
      );
    });
