...
- [x] BUG-18: Dashboard, recent transactions, and budgets page always show $ icons for other currencies - ROOT CAUSE: FinancialSummary.tsx and BudgetProgressBar.tsx had hardcoded 'USD' in formatAmount functions - FIXED: Removed local formatAmount functions and now use formatCurrency utility with baseCurrency prop. RecentTransactionsList.tsx and BudgetsPage.tsx were already correct.